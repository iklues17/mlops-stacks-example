...
# * custom_metrics_loader_function          - Specifies the name of the function in mlops_poc/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in mlops_poc/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text("model_name", "dev.mlops_poc.mlops_poc-model", "Full (Three-Level) Model Name")
