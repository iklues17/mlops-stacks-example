...
dbutils.widgets.text(
    "model_name", "dev.mlops_poc.mlops_poc-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.mlops_poc.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.mlops_poc.trip_dropoff_features",
